...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of PatrickMultipleSelectionTableview.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/pratikpanchal131/PatrickMultipleSelectionTableview'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'pratikpanchal131' => 'pratik.panchal13@gmail.com' }
  s.source           = { :git => 'https://github.com/pratikpanchal131/PatrickMultipleSelectionTableview.git', :tag => s.version.to_s }
